...
class Graph(object):
    ...
    def __generate_edges(self):
        """ Edges are represented as sets with one (a self loop) or two vertices """
        edges = []
        for vertex in self.__graph_dict:
            for neighbour in self.__graph_dict[vertex]:
                # set{} ignores multiple edges between the same two nodes
    ...
    def vertex_degree(self, vertex):
        ...
        the number of adjacent vertices. Loops are counted double, i.e.
        every occurence of vertex in the list of adjacent vertices.
        """
    ...
    def is_degree_sequence(sequence):
        """ Returns True if the "sequence" is a degree sequence, i.e.
            a non-increasing sequence.
        """
        # check if the sequence sequence is non-increasing:
        return all( x >= y for x, y in zip(sequence, sequence[1:]))  # awesome code!!
